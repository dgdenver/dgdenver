!function(t, e, n) {
    function i(n, i) {
        ...
        var o = function() {
                var n,
                    i = e.getElementById("rs-css-ready");
        ...
        t.Template.prototype = {
            ...
            ep: function(t, e) {
                ...
                if (this.partials[t].base = o, r.subs) {
                    ...
                    for (key in r.subs)
                        e.stackText[key] || (e.stackText[key] = this.activeSub !== n && e.stackText[this.activeSub] ? e.stackText[this.activeSub] : this.text);
    ...
    function(t) {
        ...
        function r(e, n, i, a) {
            ...
            for (c = i[i.length - 1]; e.length > 0;) {
                if (p = e.shift(), c && "<" == c.tag && !(p.tag in x))
                    throw new Error("Illegal content in < super tag.");
                if (t.tags[p.tag] <= t.tags.$ || o(p, a))
                    i.push(p),
                    p.nodes = r(e, p.tag, i, a);
                else {
                    if ("/" == p.tag) {
                        if (0 === i.length)
                            throw new Error("Closing tag without opener: /" + p.n);
                        if (l = i.pop(), p.n != l.n && !s(p.n, l.n, a))
        ...
        function a(t) {
            var e = [];
            for (var n in t)
                e.push('"' + l(n) + '": function(c,p,t,i) {' + t[n] + "}");
            return "{ " + e.join(",") + " }"
        }
        function u(t) {
            var e = [];
            for (var n in t.partials)
                e.push('"' + l(n) + '":{name:"' + l(t.partials[n].name) + '", ' + u(t.partials[n]) + "}");
        ...
        t.scan = function(r, o) {
            ...
            function a() {
                for (var e = !0, n = w; n < y.length; n++)
                    if (e = t.tags[y[n].tag] < t.tags._v || "_t" == y[n].tag && null === y[n].text.match(f), !e)
                        return !1;
                return e
            }
            function u(t, e) {
                if (s(), t && a())
                    for (var n, i = w; i < y.length; i++)
                        y[i].text && ((n = y[i + 1]) && ">" == n.tag && (n.indent = y[i].text.toString()), y.splice(i, 1));
                else
                    e || y.push({
                        tag: "\n"
                    });
            ...
            var c = r.length,
                ...
                T = "{{",
                C = "}}";
            for (o && (o = o.split(" "), T = o[0], C = o[1]), x = 0; x < c; x++)
        ...
        t.codegen = {
            "#": function(e, n) {
                n.code += "if(t.s(t." + c(e.n) + '("' + l(e.n) + '",c,p,1),c,p,0,' + e.i + "," + e.end + ',"' + e.otag + " " + e.ctag + '")){t.rs(c,p,function(c,p,t){',
                t.walk(e.nodes, n),
                n.code += "});c.pop();}"
            },
            "^": function(e, n) {
                n.code += "if(!t.s(t." + c(e.n) + '("' + l(e.n) + '",c,p,1),c,p,1,0,0,"")){',
                t.walk(e.nodes, n),
                n.code += "};"
            },
            ">": p,
            ...
            $: function(e, n) {
                ...
                t.walk(e.nodes, i),
                n.subs[e.n] = i.code,
                n.inPartial || (n.code += 't.sub("' + l(e.n) + '",c,p,i);')
            },
            "\n": function(t, e) {
                e.code += h('"\\n"' + (t.last ? "" : " + i"))
            },
    ...
    function(t, e) {
        ...
        function p(t, e, i, r) {
            if (ot.acceptData(t)) {
                var o,
                    ...
                    l = u ? ot.cache : t,
                    c = u ? t[a] : t[a] && a;
                if (c && l[c] && (r || l[c].data) || i !== n || "string" != typeof e)
                    return c || (c = u ? t[a] = X.pop() || ot.guid++ : a), l[c] || (l[c] = u ? {} : {
                        toJSON: ot.noop
            ...
            if (ot.acceptData(t)) {
                ...
                if (s[a]) {
                    if (e && (i = n ? s[a] : s[a].data)) {
                        ot.isArray(e) ? e = e.concat(ot.map(e, ot.camelCase)) : e in i ? e = [e] : (e = ot.camelCase(e), e = e in i ? [e] : e.split(" ")),
                        r = e.length;
                        for (; r--;)
                            delete i[e[r]];
        ...
        function b(t, e) {
            ...
            if (!s)
                for (s = [], i = t.childNodes || t; null != (r = i[o]); o++)
                    !e || ot.nodeName(r, e) ? s.push(r) : ot.merge(s, b(r, e));
        ...
        function k(e, n) {
            var i,
                r = ot(n.createElement(e)).appendTo(n.body),
        ...
        function N(t, e) {
            for (var n, i, r, o = [], s = 0, a = t.length; s < a; s++)
                i = t[s],
                i.style && (o[s] = ot._data(i, "olddisplay"), n = i.style.display, e ? (o[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Nt(i) && (o[s] = ot._data(i, "olddisplay", S(i.nodeName)))) : (r = Nt(i), (n && "none" !== n || !r) && ot._data(i, "olddisplay", r ? n : ot.css(i, "display"))));
            for (s = 0; s < a; s++)
                i = t[s],
        ...
        function L(t, e, n, i, r) {
            for (var o = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; o < 4; o += 2)
                "margin" === n && (s += ot.css(t, n + At[o], !0, r)),
                i ? ("content" === n && (s -= ot.css(t, "padding" + At[o], !0, r)), "margin" !== n && (s -= ot.css(t, "border" + At[o] + "Width", !0, r))) : (s += ot.css(t, "padding" + At[o], !0, r), "padding" !== n && (s += ot.css(t, "border" + At[o] + "Width", !0, r)));
            return s
        }
        function $(t, e, n) {
            var i = !0,
            ...
            if (r <= 0 || null == r) {
                if (r = ne(t, e, o), (r < 0 || null == r) && (r = t.style[e]), re.test(r))
                    return r;
        ...
        function M(t, e, i) {
            ...
            i.queue || (u = ot._queueHooks(t, "fx"), null == u.unqueued && (u.unqueued = 0, l = u.empty.fire, u.empty.fire = function() {
                ...
                d.always(function() {
                    u.unqueued--,
                    ot.queue(t, "fx").length || u.empty.fire()
                })
            })),
            1 === t.nodeType && ("height" in e || "width" in e) && (i.overflow = [f.overflow, f.overflowX, f.overflowY], c = ot.css(t, "display"), p = "none" === c ? ot._data(t, "olddisplay") || S(t.nodeName) : c, "inline" === p && "none" === ot.css(t, "float") && (it.inlineBlockNeedsLayout && "inline" !== S(t.nodeName) ? f.zoom = 1 : f.display = "inline-block")),
            i.overflow && (f.overflow = "hidden", it.shrinkWrapBlocks() || d.always(function() {
            ...
            if (ot.isEmptyObject(h))
                "inline" === ("none" === c ? S(t.nodeName) : c) && (f.display = c);
            else {
                m ? "hidden" in m && (g = m.hidden) : m = ot._data(t, "fxshow", {}),
                s && (m.hidden = !g),
                g ? ot(t).show() : d.done(function() {
                    ot(t).hide()
                }),
                d.done(function() {
                    var e;
                ...
                for (r in h)
                    a = R(g ? m[r] : 0, r, d),
                    r in m || (m[r] = a.start, g && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
            }
        }
        function I(t, e) {
            var n,
        ...
        function O(t, e, n) {
            var i,
                ...
                u = function() {
                    if (r)
                        return !1;
                    for (var e = fe || P(), n = Math.max(0, l.startTime + l.duration - e), i = n / l.duration || 0, o = 1 - i, s = 0, u = l.tweens.length; s < u; s++)
                        l.tweens[s].run(o);
        ...
        function F(t, e) {
            ...
            for (r in e)
                e[r] !== n && ((o[r] ? t : i || (i = {}))[r] = e[r]);
            return i && ot.extend(!0, t, i), t
        }
        function z(t, e, i) {
            for (var r, o, s, a, u = t.contents, l = t.dataTypes; "*" === l[0];)
                l.shift(),
                o === n && (o = t.mimeType || e.getResponseHeader("Content-Type"));
            if (o)
                for (a in u)
                    if (u[a] && u[a].test(o)) {
                        l.unshift(a);
            ...
            for ("boolean" == typeof a && (c = a, a = arguments[u] || {}, u++), "object" == typeof a || ot.isFunction(a) || (a = {}), u === l && (a = this, u--); u < l; u++)
                if (null != (o = arguments[u]))
                    for (r in o)
                        t = a[r],
                        i = o[r],
                        a !== i && (c && i && (ot.isPlainObject(i) || (e = ot.isArray(i))) ? (e ? (e = !1, s = t && ot.isArray(t) ? t : []) : s = t && ot.isPlainObject(t) ? t : {}, a[r] = ot.extend(c, s, i)) : i !== n && (a[r] = i));
            return a
        },
        ot.extend({
            ...
            merge: function(t, e) {
                for (var i = +e.length, r = 0, o = t.length; r < i;)
                    t[o++] = e[r++];
                if (i !== i)
                    for (; e[r] !== n;)
                        t[o++] = e[r++];
        ...
        var ct = function(t) {
            function e(t, e, n, i) {
                var r,
                    ...
                    f,
                    g;
                if ((e ? e.ownerDocument || e : B) !== j && $(e), e = e || j, n = n || [], !t || "string" != typeof t)
                    return n;
                ...
                if (H && !i) {
                    if (r = yt.exec(t))
                        if (s = r[1]) {
                            ...
                            if ((s = r[3]) && w.getElementsByClassName && e.getElementsByClassName)
                                return tt.apply(n, e.getElementsByClassName(s)), n
                        }
                    if (w.qsa && (!R || !R.test(t))) {
                        if (d = c = q, f = e, g = 9 === a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                            for (l = S(t), (c = e.getAttribute("id")) ? d = c.replace(xt, "\\$&") : e.setAttribute("id", d), d = "[id='" + d + "'] ", u = l.length; u--;)
                                l[u] = d + h(l[u]);
                            f = _t.test(t) && p(e.parentNode) || e,
                            g = l.join(",")
                        }
                        if (g)
                            try {
            ...
            function f(t, e, n) {
                ...
                return e.first ? function(e, n, o) {
                    ...
                    if (s) {
                        ...
                        for (; e = e[i];)
                            if (1 === e.nodeType || r) {
                                if (u = e[q] || (e[q] = {}), (a = u[i]) && a[0] === F && a[1] === o)
                                    return l[2] = a[2];
            ...
            function v(t, e, n, i, o, s) {
                return i && !i[q] && (i = v(i)), o && !o[q] && (o = v(o, s)), r(function(r, s, a, u) {
                    var l,
                        ...
                        y = n ? o || (r ? t : f || i) ? [] : s : v;
                    if (n && n(v, y, a, u), i)
                        for (l = b(y, h), i(l, [], a, u), c = l.length; c--;)
                            (p = l[c]) && (y[h[c]] = !(v[h[c]] = p));
                    if (r) {
                        if (o || t) {
                            if (o) {
                            ...
                            for (c = y.length; c--;)
                                (p = y[c]) && (l = o ? nt.call(r, p) : d[c]) > -1 && (r[l] = !(s[l] = p))
                        }
                    } else
                        y = b(y === s ? y.splice(f, y.length) : y),
                        o ? o(null, s, y, u) : tt.apply(s, y)
                })
            }
            function y(t) {
                    ...
                    s = function(r, s, a, u, l) {
                        ...
                        if (h += f, i && f !== h) {
                            ...
                            if (r) {
                                if (h > 0)
                                    for (; f--;)
                                        g[f] || m[f] || (m[f] = J.call(u));
                                m = b(m)
                            }
                            tt.apply(u, m),
                            l && !r && m.length > 0 && h + n.length > 1 && e.uniqueSort(u)
                        }
                        return l && (F = _, N = v), g
                    };
                return i ? r(s) : s
            ...
            try {
                tt.apply(G = et.call(B.childNodes), B.childNodes),
            ...
            $ = e.setDocument = function(t) {
                ...
                return n !== j && 9 === n.nodeType && n.documentElement ? (j = n, P = n.documentElement, H = !k(n), i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", function() {
                    ...
                    if (typeof e.getElementsByTagName !== Q)
                    ...
                    if (typeof e.getElementsByClassName !== Q && H)
                        return e.getElementsByClassName(t)
                }, M = [], R = [], (w.qsa = vt.test(n.querySelectorAll)) && (o(function(t) {
                    t.innerHTML = "<select msallowclip=''><option selected=''></option></select>",
                    t.querySelectorAll("[msallowclip^='']").length && R.push("[*^$]=" + rt + "*(?:''|\"\")"),
                    t.querySelectorAll("[selected]").length || R.push("\\[" + rt + "*(?:value|" + it + ")"),
                    ...
                    var i,
                        ...
                        l = [e];
                    if (!o || !s)
                        return t === n ? -1 : e === n ? 1 : o ? -1 : s ? 1 : D ? nt.call(D, t) - nt.call(D, e) : 0;
                    if (o === s)
                        return a(t, e);
            ...
            e.matchesSelector = function(t, n) {
                if ((t.ownerDocument || t) !== j && $(t), n = n.replace(dt, "='$1']"), w.matchesSelector && H && (!M || !M.test(n)) && (!R || !R.test(n)))
                    try {
                        var i = I.call(t, n);
                        ...
                        return 1 === i && 0 === r ? function(t) {
                            ...
                            if (m) {
                                if (o) {
                                    for (; g;) {
                                        for (p = e; p = p[g];)
                                            if (a ? p.nodeName.toLowerCase() === b : 1 === p.nodeType)
                                                return !1;
                                ...
                                } else if (v && (l = (e[q] || (e[q] = {}))[t]) && l[0] === F)
                                    d = l[1];
                                else
                                    for (; (p = ++h && p && p[g] || (d = h = 0) || f.pop()) && ((a ? p.nodeName.toLowerCase() !== b : 1 !== p.nodeType) || !++d || (v && ((p[q] || (p[q] = {}))[t] = [F, d]), p !== e));)
                                        ;
                ...
                pseudos: {
                    ...
                    lang: r(function(t) {
                        return ft.test(t || "") || e.error("unsupported lang: " + t), t = t.replace(wt, Tt).toLowerCase(), function(e) {
                            var n;
                            do if (n = H ? e.lang : e.getAttribute("xml:lang") || e.getAttribute("lang"))
            ...
            return d.prototype = T.filters = T.pseudos, T.setFilters = new d, S = e.tokenize = function(t, n) {
                ...
                for (a = t, u = [], l = T.preFilter; a;) {
                    i && !(r = ct.exec(a)) || (r && (a = a.slice(r[0].length) || a), u.push(o = [])),
                    i = !1,
                    (r = pt.exec(a)) && (i = r.shift(), o.push({
                        value: i,
                        type: r[0].replace(lt, " ")
                    }), a = a.slice(i.length));
                    for (s in T.filter)
                        !(r = gt[s].exec(a)) || l[s] && !(r = l[s](r)) || (i = r.shift(), o.push({
                            value: i,
                            type: s,
                            matches: r
                        }), a = a.slice(i.length));
                ...
                if (n = n || [], 1 === c.length) {
                    if (o = c[0] = c[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && w.getById && 9 === e.nodeType && H && T.relative[o[1].type]) {
                        if (e = (T.find.ID(s.matches[0].replace(wt, Tt), e) || [])[0], !e)
                            return n;
                        l && (e = e.parentNode),
        ...
        ot.extend({
            dir: function(t, e, i) {
                for (var r = [], o = t[e]; o && 9 !== o.nodeType && (i === n || 1 !== o.nodeType || !ot(o).is(i));)
        ...
        ot.Callbacks = function(t) {
            ...
            var e,
                ...
                p = function(n) {
                    ...
                    e = !1,
                    l && (c ? c.length && p(c.shift()) : i ? l = [] : d.disable())
                },
                d = {
                    add: function() {
                        if (l) {
            ...
            when: function(t) {
                ...
                if (s > 1)
                    for (e = new Array(s), n = new Array(s), i = new Array(s); r < s; r++)
                        o[r] && ot.isFunction(o[r].promise) ? o[r].promise().done(l(r, i, o)).fail(u.reject).progress(l(r, n, e)) : --a;
        ...
        ot.extend({
            ...
            ready: function(t) {
                if (t === !0 ? !--ot.readyWait : !ot.isReady) {
                    ...
                    ot.isReady = !0,
                    t !== !0 && --ot.readyWait > 0 || (wt.resolveWith(gt, [ot]), ot.fn.triggerHandler && (ot(gt).triggerHandler("ready"), ot(gt).off("ready")))
                }
            }
        }),
        ot.ready.promise = function(e) {
            if (!wt)
                if (wt = ot.Deferred(), "complete" === gt.readyState)
                    setTimeout(ot.ready);
                else if (gt.addEventListener)
                    gt.addEventListener("DOMContentLoaded", u, !1),
                    t.addEventListener("load", u, !1);
                else {
                    gt.attachEvent("onreadystatechange", u),
            ...
            data: function(t, e) {
                ...
                if (t === n) {
                    if (this.length && (o = ot.data(s), 1 === s.nodeType && !ot._data(s, "parsedAttrs"))) {
                        for (i = a.length; i--;)
                            a[i] && (r = a[i].name, 0 === r.indexOf("data-") && (r = ot.camelCase(r.slice(5)), l(s, r, o[r])));
        ...
        ot.extend({
            queue: function(t, e, n) {
                var i;
                if (t)
                    return e = (e || "fx") + "queue", i = ot._data(t, e), n && (!i || ot.isArray(n) ? i = ot._data(t, e, ot.makeArray(n)) : i.push(n)), i || []
            },
        ...
        ot.fn.extend({
            ...
            promise: function(t, e) {
                ...
                for ("string" != typeof t && (e = t, t = n), t = t || "fx"; a--;)
                    i = ot._data(s[a], t + "queueHooks"),
        ...
        ot.event = {
            ...
            add: function(t, e, i, r, o) {
                ...
                if (b) {
                    ...
                    }, p.elem = t), e = (e || "").match(_t) || [""], u = e.length; u--;)
                        s = Rt.exec(e[u]) || [],
                        f = m = s[1],
                        g = (s[2] || "").split(".").sort(),
                        f && (c = ot.event.special[f] || {}, f = (o ? c.delegateType : c.bindType) || f, c = ot.event.special[f] || {}, d = ot.extend({
                            type: f,
                            origType: m,
                            data: r,
                            handler: i,
            ...
            remove: function(t, e, n, i, r) {
                var o,
                    ...
                    f,
                    g,
                    m = ot.hasData(t) && ot._data(t);
                if (m && (c = m.events)) {
                    for (e = (e || "").match(_t) || [""], l = e.length; l--;)
                        if (a = Rt.exec(e[l]) || [], h = g = a[1], f = (a[2] || "").split(".").sort(), h) {
                            for (p = ot.event.special[h] || {}, h = (i ? p.delegateType : p.bindType) || h, d = c[h] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), u = o = d.length; o--;)
                                s = d[o],
                                !r && g !== s.origType || n && n.guid !== s.guid || a && !a.test(s.namespace) || i && i !== s.selector && ("**" !== i || !s.selector) || (d.splice(o, 1), s.selector && d.delegateCount--, p.remove && p.remove.call(t, s));
                            u && !d.length && (p.teardown && p.teardown.call(t, f, m.handle) !== !1 || ot.removeEvent(t, h, m.handle), delete c[h])
                        } else
                            for (h in c)
                                ot.event.remove(t, h + e[l], n, i, !0);
            ...
            trigger: function(e, i, r, o) {
                ...
                if (u = p = r = r || gt, 3 !== r.nodeType && 8 !== r.nodeType && !Ht.test(f + ot.event.triggered) && (f.indexOf(".") >= 0 && (g = f.split("."), f = g.shift(), g.sort()), a = f.indexOf(":") < 0 && "on" + f, e = e[ot.expando] ? e : new ot.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = g.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = n, e.target || (e.target = r), i = null == i ? [e] : ot.makeArray(i, [e]), c = ot.event.special[f] || {}, o || !c.trigger || c.trigger.apply(r, i) !== !1)) {
                    if (!o && !c.noBubble && !ot.isWindow(r)) {
                        for (l = c.delegateType || f, Ht.test(l + f) || (u = u.parentNode); u; u = u.parentNode)
                            h.push(u),
                            p = u;
                    ...
                    for (d = 0; (u = h[d++]) && !e.isPropagationStopped();)
                        ...
                        s = (ot._data(u, "events") || {})[e.type] && ot._data(u, "handle"),
                        s && s.apply(u, i),
                        s = a && u[a],
                        s && s.apply && ot.acceptData(u) && (e.result = s.apply(u, i), e.result === !1 && e.preventDefault());
            ...
            dispatch: function(t) {
                ...
                if (u[0] = t, t.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, t) !== !1) {
                    for (a = ot.event.handlers.call(this, t, l), e = 0; (o = a[e++]) && !t.isPropagationStopped();)
                        for (t.currentTarget = o.elem, s = 0; (r = o.handlers[s++]) && !t.isImmediatePropagationStopped();)
                            t.namespace_re && !t.namespace_re.test(r.namespace) || (t.handleObj = r, t.data = r.data, i = ((ot.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, u), i !== n && (t.result = i) === !1 && (t.preventDefault(), t.stopPropagation()));
                    ...
                    for (; l != this; l = l.parentNode || this)
                        if (1 === l.nodeType && (l.disabled !== !0 || "click" !== t.type)) {
                            for (o = [], s = 0; s < u; s++)
                                r = e[s],
                                i = r.selector + " ",
                                o[i] === n && (o[i] = r.needsContext ? ot(i, this).index(l) >= 0 : ot.find(i, this, null, [l]).length),
                                o[i] && o.push(r);
                            o.length && a.push({
                                elem: l,
                                handlers: o
            ...
            fix: function(t) {
                ...
                var e,
                    ...
                    o = t,
                    s = this.fixHooks[r];
                for (s || (this.fixHooks[r] = s = Pt.test(r) ? this.mouseHooks : jt.test(r) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, t = new ot.Event(o), e = i.length; e--;)
                    n = i[e],
                    t[n] = o[n];
            ...
            special: {
                ...
                click: {
                    trigger: function() {
                        if (ot.nodeName(this, "input") && "checkbox" === this.type && this.click)
                            return this.click(), !1
                    },
                    _default: function(t) {
            ...
            simulate: function(t, e, n, i) {
                ...
                i ? ot.event.trigger(r, null, e) : ot.event.dispatch.call(e, r),
        ...
        ot.fn.extend({
            on: function(t, e, i, r, o) {
                ...
                if (null == i && null == r ? (r = e, i = e = n) : null == r && ("string" == typeof e ? (r = i, i = n) : (r = i, i = e, e = n)), r === !1)
                    r = f;
                else if (!r)
                    return this;
            ...
            off: function(t, e, i) {
                ...
                if (t && t.preventDefault && t.handleObj)
                    return r = t.handleObj, ot(t.delegateTarget).off(r.namespace ? r.origType + "." + r.namespace : r.origType, r.selector, r.handler), this;
                if ("object" == typeof t) {
                    for (o in t)
                        this.off(o, e, t[o]);
                    return this
        ...
        ot.extend({
            clone: function(t, e, n) {
                ...
                if (it.html5Clone || ot.isXMLDoc(t) || !Ot.test("<" + t.nodeName + ">") ? o = t.cloneNode(!0) : (Jt.innerHTML = t.outerHTML, Jt.removeChild(o = Jt.firstChild)), !(it.noCloneEvent && it.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ot.isXMLDoc(t)))
                    for (i = b(o), a = b(t), s = 0; null != (r = a[s]); ++s)
                        i[s] && C(r, i[s]);
                if (e)
                    if (n)
                        for (a = a || b(t), i = i || b(o), s = 0; null != (r = a[s]); s++)
                            T(r, i[s]);
                    else
                        T(t, o);
                ...
                for (var r, o, s, a, u, l, c, p = t.length, d = m(e), h = [], f = 0; f < p; f++)
                    if (o = t[f], o || 0 === o)
                        if ("object" === ot.type(o))
                            ...
                            for (a = a || d.appendChild(e.createElement("div")), u = (Ft.exec(o) || ["", ""])[1].toLowerCase(), c = Yt[u] || Yt._default, a.innerHTML = c[1] + o.replace(Bt, "<$1></$2>") + c[2], r = c[0]; r--;)
                                a = a.lastChild;
                            if (!it.leadingWhitespace && qt.test(o) && h.push(e.createTextNode(qt.exec(o)[0])), !it.tbody)
                                for (o = "table" !== u || zt.test(o) ? "<table>" !== c[1] || zt.test(o) ? 0 : a : a.firstChild, r = o && o.childNodes.length; r--;)
                                    ot.nodeName(l = o.childNodes[r], "tbody") && !l.childNodes.length && o.removeChild(l);
                            for (ot.merge(h, a.childNodes), a.textContent = ""; a.firstChild;)
            ...
            cleanData: function(t, e) {
                for (var n, i, r, o, s = 0, a = ot.expando, u = ot.cache, l = it.deleteExpando, c = ot.event.special; null != (n = t[s]); s++)
                    if ((e || ot.acceptData(n)) && (r = n[a], o = r && u[r])) {
                        if (o.events)
                            for (i in o.events)
                                c[i] ? ot.event.remove(n, i) : ot.removeEvent(n, i, o.handle);
        ...
        ot.fn.extend({
            ...
            remove: function(t, e) {
                for (var n, i = t ? ot.filter(t, this) : this, r = 0; null != (n = i[r]); r++)
                    e || 1 !== n.nodeType || ot.cleanData(b(n)),
                    n.parentNode && (e && ot.contains(n.ownerDocument, n) && w(b(n, "script")), n.parentNode.removeChild(n));
                return this
            },
            empty: function() {
                for (var t, e = 0; null != (t = this[e]); e++) {
                    for (1 === t.nodeType && ot.cleanData(b(t, !1)); t.firstChild;)
            ...
            domManip: function(t, e) {
                ...
                var n,
                    ...
                    d = t[0],
                    h = ot.isFunction(d);
                if (h || l > 1 && "string" == typeof d && !it.checkClone && Ut.test(d))
                    return this.each(function(n) {
                        var i = c.eq(n);
                        h && (t[0] = d.call(this, n, i.html())),
                        i.domManip(t, e)
                    });
                if (l && (a = ot.buildFragment(t, this[0].ownerDocument, !1, this), n = a.firstChild, 1 === a.childNodes.length && (a = n), n)) {
                    for (o = ot.map(b(a, "script"), _), r = o.length; u < l; u++)
                        i = a,
                        u !== p && (i = ot.clone(i, !0, !0), r && ot.merge(o, b(i, "script"))),
                        e.call(this[u], i, u);
                    if (r)
                        for (s = o[o.length - 1].ownerDocument, ot.map(o, x), u = 0; u < r; u++)
                            i = o[u],
                            Vt.test(i.type || "") && !ot._data(i, "globalEval") && ot.contains(s, i) && (i.src ? ot._evalUrl && ot._evalUrl(i.src) : ot.globalEval((i.text || i.textContent || i.innerHTML || "").replace(Xt, "")));
                    a = n = null
                }
                return this
            }
        ...
        ot.each({
            ...
            ot.fn[t] = function(t) {
                for (var n, i = 0, r = [], o = ot(t), s = o.length - 1; i <= s; i++)
        ...
        function() {
            ...
            i = r && r.style,
            i && (i.cssText = "float:left;opacity:.5", it.opacity = "0.5" === i.opacity, it.cssFloat = !!i.cssFloat, n.style.backgroundClip = "content-box", n.cloneNode(!0).style.backgroundClip = "", it.clearCloneStyle = "content-box" === n.style.backgroundClip, it.boxSizing = "" === i.boxSizing || "" === i.MozBoxSizing || "" === i.WebkitBoxSizing, ot.extend(it, {
            ...
            style: function(t, e, i, r) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    var o,
                        ...
                        u = ot.camelCase(e),
                        l = t.style;
                    if (e = ot.cssProps[u] || (ot.cssProps[u] = A(l, u)), a = ot.cssHooks[e] || ot.cssHooks[u], i === n)
                        return a && "get" in a && (o = a.get(t, !1, r)) !== n ? o : l[e];
                    if (s = typeof i, "string" === s && (o = ce.exec(i)) && (i = (o[1] + 1) * o[2] + parseFloat(ot.css(t, e)), s = "number"), null != i && i === i && ("number" !== s || ot.cssNumber[u] || (i += "px"), it.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (l[e] = "inherit"), !(a && "set" in a && (i = a.set(t, i, r)) === n)))
                        try {
                            l[e] = i
                        } catch (c) {}
                }
        ...
        ot.each(["height", "width"], function(t, e) {
            ot.cssHooks[e] = {
                get: function(t, n, i) {
                    if (n)
                        return ue.test(ot.css(t, "display")) && 0 === t.offsetWidth ? ot.swap(t, pe, function() {
                            return $(t, e, i)
                        }) : $(t, e, i)
                },
                set: function(t, n, i) {
        ...
        it.opacity || (ot.cssHooks.opacity = {
            ...
            set: function(t, e) {
                ...
                n.zoom = 1,
                (e >= 1 || "" === e) && "" === ot.trim(o.replace(se, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === e || i && !i.filter) || (n.filter = se.test(o) ? o.replace(se, r) : o + " " + r)
            }
        }),
            ...
            css: function(t, e) {
                return Dt(this, function(t, e, i) {
                    var r,
                        ...
                        a = 0;
                    if (ot.isArray(e)) {
                        for (r = ee(t), o = e.length; a < o; a++)
                            s[e[a]] = ot.css(t, e[a], !1, r);
                        return s
                    }
            ...
            finish: function(t) {
                return t !== !1 && (t = t || "fx"), this.each(function() {
                    var e,
                        ...
                        o = ot.timers,
                        s = i ? i.length : 0;
                    for (n.finish = !0, ot.queue(this, t, []), r && r.stop && r.stop.call(this, !0), e = o.length; e--;)
        ...
        function() {
            ...
            r = n.appendChild(gt.createElement("option")),
            t = e.getElementsByTagName("input")[0],
            i.style.cssText = "top:1px",
            it.getSetAttribute = "t" !== e.className,
            it.style = /top/.test(i.getAttribute("style")),
            it.hrefNormalized = "/a" === i.getAttribute("href"),
            it.checkOn = !!t.value,
        ...
        ot.fn.extend({
            val: function(t) {
                ...
                {
                    if (arguments.length)
                        return r = ot.isFunction(t), this.each(function(i) {
                            var o;
                    ...
                    if (o)
                        return e = ot.valHooks[o.type] || ot.valHooks[o.nodeName.toLowerCase()], e && "get" in e && (i = e.get(o, "value")) !== n ? i : (i = o.value, "string" == typeof i ? i.replace(xe, "") : null == i ? "" : i)
                }
            }
        }),
        ot.extend({
                ...
                select: {
                    ...
                    set: function(t, e) {
                        for (var n, i, r = t.options, o = ot.makeArray(e), s = r.length; s--;)
                            if (i = r[s], ot.inArray(ot.valHooks.option.get(i), o) >= 0)
                                try {
                                    i.selected = n = !0
                                } catch (a) {
                                    i.scrollHeight
        ...
        ot.each(["radio", "checkbox"], function() {
            ot.valHooks[this] = {
                set: function(t, e) {
                    if (ot.isArray(e))
                        return t.checked = ot.inArray(ot(t).val(), e) >= 0
                }
            },
        ...
        ot.extend({
            attr: function(t, e, i) {
                var r,
                    ...
                    s = t.nodeType;
                if (t && 3 !== s && 8 !== s && 2 !== s)
                    return typeof t.getAttribute === Ct ? ot.prop(t, e, i) : (1 === s && ot.isXMLDoc(t) || (e = e.toLowerCase(), r = ot.attrHooks[e] || (ot.expr.match.bool.test(e) ? Te : we)), i === n ? r && "get" in r && null !== (o = r.get(t, e)) ? o : (o = ot.find.attr(t, e), null == o ? n : o) : null !== i ? r && "set" in r && (o = r.set(t, i, e)) !== n ? o : (t.setAttribute(e, i + ""), i) : void ot.removeAttr(t, e))
            },
            removeAttr: function(t, e) {
                ...
                if (o && 1 === t.nodeType)
                    for (; n = o[r++];)
                        i = ot.propFix[n] || n,
                        ot.expr.match.bool.test(n) ? Ee && Se || !ke.test(n) ? t[i] = !1 : t[ot.camelCase("default-" + n)] = t[i] = !1 : ot.attr(t, n, ""),
        ...
        ot.each(ot.expr.match.bool.source.match(/\w+/g), function(t, e) {
            ...
            Ce[e] = Ee && Se || !ke.test(e) ? function(t, e, i) {
                ...
                if (!n)
                    return t[ot.camelCase("default-" + e)] ? e.toLowerCase() : null
            }
        }),
        ...
        ot.extend({
            ...
            prop: function(t, e, i) {
                var r,
                    ...
                    a = t.nodeType;
                if (t && 3 !== a && 8 !== a && 2 !== a)
                    return s = 1 !== a || !ot.isXMLDoc(t), s && (e = ot.propFix[e] || e, o = ot.propHooks[e]), i !== n ? o && "set" in o && (r = o.set(t, i, e)) !== n ? r : t[e] = i : o && "get" in o && null !== (r = o.get(t, e)) ? r : t[e]
            },
            propHooks: {
                tabIndex: {
                    get: function(t) {
        ...
        ot.fn.extend({
            ...
            toggleClass: function(t, e) {
                ...
                return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : ot.isFunction(t) ? this.each(function(n) {
                    ...
                    if ("string" === n)
                        for (var e, i = 0, r = ot(this), o = t.match(_t) || []; e = o[i++];)
                            r.hasClass(e) ? r.removeClass(e) : r.addClass(e);
                    else
                        n !== Ct && "boolean" !== n || (this.className && ot._data(this, "__className__", this.className), this.className = this.className || t === !1 ? "" : ot._data(this, "__className__") || "")
                })
            },
            hasClass: function(t) {
                for (var e = " " + t + " ", n = 0, i = this.length; n < i; n++)
                    if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(De, " ").indexOf(e) >= 0)
                        return !0;
                return !1
            }
        }),
        ...
        try {
            ...
            He = gt.createElement("a"),
            He.href = "",
            He = He.href
        }
        Pe = Fe.exec(He.toLowerCase()) || [],
        ot.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ...
            ajax: function(t, e) {
                ...
                if (g.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, d.url = ((t || d.url || He) + "").replace(Re, "").replace(Be, Pe[1] + "//"), d.type = e.method || e.type || d.method || d.type, d.dataTypes = ot.trim(d.dataType || "*").toLowerCase().match(_t) || [""], null == d.crossDomain && (r = Fe.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === Pe[1] && r[2] === Pe[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (Pe[3] || ("http:" === Pe[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = ot.param(d.data, d.traditional)), B(ze, d, e, w), 2 === _)
                    return w;
                l = d.global,
                ...
                s = d.url,
                d.hasContent || (d.data && (s = d.url += ($e.test(s) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = Me.test(s) ? s.replace(Me, "$1_=" + Le++) : s + ($e.test(s) ? "&" : "?") + "_=" + Le++)),
                d.ifModified && (ot.lastModified[s] && w.setRequestHeader("If-Modified-Since", ot.lastModified[s]), ot.etag[s] && w.setRequestHeader("If-None-Match", ot.etag[s])),
                (d.data && d.hasContent && d.contentType !== !1 || e.contentType) && w.setRequestHeader("Content-Type", d.contentType),
                w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + We + "; q=0.01" : "") : d.accepts["*"]);
                for (o in d.headers)
        ...
        ot.param = function(t, e) {
            ...
            if (e === n && (e = ot.ajaxSettings && ot.ajaxSettings.traditional), ot.isArray(t) || t.jquery && !ot.isPlainObject(t))
                ot.each(t, function() {
        ...
        tn = it.ajax = !!tn,
        tn && ot.ajaxTransport(function(t) {
            if (!t.crossDomain || it.cors) {
                ...
                return {
                    send: function(i, r) {
                        ...
                        for (o in i)
                            i[o] !== n && s.setRequestHeader(o, i[o] + "");
                        ...
                        e = function(i, o) {
                            ...
                            if (e && (o || 4 === s.readyState))
                                if (delete Ze[a], e = n, s.onreadystatechange = ot.noop, o)
        ...
        ot.ajaxTransport("script", function(t) {
            if (t.crossDomain) {
                var e,
                    i = gt.head || ot("head")[0] || gt.documentElement;
                return {
                    send: function(n, r) {
        ...
        ot.ajaxPrefilter("json jsonp", function(e, i, r) {
            var o,
                s,
                a,
                u = e.jsonp !== !1 && (nn.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && nn.test(e.data) && "data");
            if (u || "jsonp" === e.dataTypes[0])
                return o = e.jsonpCallback = ot.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, u ? e[u] = e[u].replace(nn, "$1" + o) : e.jsonp !== !1 && (e.url += ($e.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function() {
                    return a || ot.error(o + " was not called"), a[0]
                }, e.dataTypes[0] = "json", s = t[o], t[o] = function() {
                    a = arguments
                }, r.always(function() {
                    t[o] = s,
                    e[o] && (e.jsonpCallback = i.jsonpCallback, en.push(o)),
        ...
        ot.offset = {
            setOffset: function(t, e, n) {
                ...
                l ? (i = p.position(), s = i.top, r = i.left) : (s = parseFloat(o) || 0, r = parseFloat(u) || 0),
        ...
        ot.fn.extend({
            offset: function(t) {
                if (arguments.length)
                    return t === n ? this : this.each(function(e) {
                ...
                var e,
                    ...
                    s = o && o.ownerDocument;
                if (s)
                    return e = s.documentElement, ot.contains(e, o) ? (typeof o.getBoundingClientRect !== Ct && (r = o.getBoundingClientRect()), i = Q(s), {
        ...
        ot.each(["top", "left"], function(t, e) {
            ot.cssHooks[e] = E(it.pixelPosition, function(t, n) {
                if (n)
                    return n = ne(t, e), re.test(n) ? ot(t).position()[e] + "px" : n
            })
        }),
        ot.each({
            Height: "height",
        ...
        var e = {
            init: function(n) {
                ...
                return i.pages = i.pages ? i.pages : Math.ceil(i.items / i.itemsOnPage) ? Math.ceil(i.items / i.itemsOnPage) : 1, i.currentPage ? i.currentPage = i.currentPage - 1 : i.currentPage = i.invertPageOrder ? i.pages - 1 : 0, i.halfDisplayed = i.displayedPages / 2, this.each(function() {
                    r.addClass(i.cssStyle + " simple-pagination").data("pagination", i),
                    e._draw.call(r)
                }), i.onInit(), this
            },
            ...
            _draw: function() {
                var n,
                    ...
                    o = e._getInterval(r);
                e.destroy.call(this),
                i = "function" == typeof this.prop ? this.prop("tagName") : this.attr("tagName");
                ...
                if (r.prevText && e._appendItem.call(this, r.invertPageOrder ? r.currentPage + 1 : r.currentPage - 1, {
                    ...
                    if (o.end < r.pages && r.edges > 0) {
                        ...
                        for (n = r.pages - 1; n >= a; n--)
                            e._appendItem.call(this, n);
                ...
                if (r.invertPageOrder)
                    for (n = o.end - 1; n >= o.start; n--)
                        e._appendItem.call(this, n);
                else
                    for (n = o.start; n < o.end; n++)
                        e._appendItem.call(this, n);
                if (r.invertPageOrder) {
            ...
            _appendItem: function(n, i) {
                var r,
                    ...
                    u = t("<li></li>"),
                    l = s.find("ul");
                n = n < 0 ? 0 : n < a.pages ? n : a.pages - 1,
                r = {
                    text: n + 1,
                    classes: ""
                },
                a.labelMap.length && a.labelMap[n] && (r.text = a.labelMap[n]),
                r = t.extend(r, i || {}),
                n == a.currentPage || a.disabled ? (a.disabled ? u.addClass("disabled") : u.addClass("active"), o = t('<span class="current">' + r.text + "</span>")) : (o = t('<a href="' + a.hrefTextPrefix + (n + 1) + a.hrefTextSuffix + '" class="page-link">' + r.text + "</a>"), o.click(function(t) {
                    return e._selectPage.call(s, n, t)
                })),
                r.classes && o.addClass(r.classes),
                u.append(o),
                l.length ? l.append(u) : s.append(u)
            },
    ...
    function(n) {
        var i = function() {
            ...
            s = function() {
                "use strict";
                function t(t) {
                    this.maxSize = i.isNumber(t) ? t : 100,
                    this.reset(),
            ...
            a = function() {
                ...
                function e(t) {
                    ...
                    this.ttlKey = "__ttl__",
                    this.keyMatcher = new RegExp("^" + i.escapeRegExChars(this.prefix))
                }
                function n() {
                ...
                return a = s && t.JSON ? {
                    ...
                    clear: function() {
                        var t,
                            ...
                            i = s.length;
                        for (t = 0; t < i; t++)
                            (e = s.key(t)).match(this.keyMatcher) && n.push(e.replace(this.keyMatcher, ""));
                        for (t = n.length; t--;)
                            this.remove(n[t]);
                        return this
                    },
            ...
            u = function() {
                ...
                function t(t) {
                    ...
                    this.cancelled = !1,
                    this.lastUrl = null,
                    this._send = t.transport ? e(t.transport) : n.ajax,
                    this._get = t.rateLimiter ? t.rateLimiter(this._get) : this._get,
                    this._cache = t.cache === !1 ? new s(0) : u
                }
                function e(t) {
                    return function(e, r) {
                        function o(t) {
            ...
            l = function() {
                ...
                function s(t, e) {
                    ...
                    t = t.sort(n),
                    e = e.sort(n);
                    for (var s = t.length, a = e.length; i < s && r < a;)
        ...
        !function(t) {
            ...
            function e(t) {
                ...
                this.sorter = r(t.sorter),
                this.dupDetector = t.dupDetector || s,
                this.local = c.local(t),
                this.prefetch = c.prefetch(t),
                this.remote = c.remote(t),
            ...
            return p = t.Bloodhound, d = {
                ...
                _loadPrefetch: function(t) {
                    function e(e) {
                        o.clear(),
                        o.add(t.filter ? t.filter(e) : e),
                        o._saveToStorage(o.index.serialize(), t.thumbprint, t.ttl)
                    }
                    var i,
                        r,
                        o = this;
                ...
                get: function(t, e) {
                    ...
                    o.length < this.limit ? s = this._getFromRemote(t, n) : this._cancelLastRemoteRequest(),
                    s || (o.length > 0 || !this.transport) && e && e(o)
                },
                clear: function() {
                    this.index.reset()
                },
        ...
        var p = function() {
            ...
            f = function() {
                ...
                function e(t, e, n, i) {
                    ...
                    if (!n)
                        return this;
                    for (e = e.split(l), n = i ? u(n, i) : n, this._callbacks = this._callbacks || {}; r = e.shift();)
                ...
                function o(t) {
                    ...
                    if (!this._callbacks)
                        return this;
                    for (t = t.split(l), i = [].slice.call(arguments, 1); (e = t.shift()) && (n = this._callbacks[e]);)
            ...
            g = function(t) {
                ...
                return function(r) {
                    ...
                    var a;
                    r = i.mixin({}, n, r),
                    r.node && r.pattern && (r.pattern = i.isArray(r.pattern) ? r.pattern : [r.pattern], a = e(r.pattern, r.caseSensitive, r.wordsOnly), s(r.node, o))
                }
            }(t.document),
            m = function() {
                "use strict";
                function t(t) {
                    var e,
                        ...
                        l = this;
                    t = t || {},
                    t.input || n.error("input is missing"),
                    e = i.bind(this._onBlur, this),
                    o = i.bind(this._onFocus, this),
                    s = i.bind(this._onKeydown, this),
                    u = i.bind(this._onInput, this),
                    this.$hint = n(t.hint),
                    this.$input = n(t.input).on("blur.tt", e).on("focus.tt", o).on("keydown.tt", s),
                    0 === this.$hint.length && (this.setHint = this.getHint = this.clearHint = this.clearHintIfInvalid = i.noop),
                ...
                return a = {
                    ...
                    _checkInputValue: function() {
                        ...
                        e = o(t, this.query),
                        n = !!e && this.query.length !== t.length,
                        this.query = t,
            ...
            b = function() {
                ...
                function t(t) {
                    ...
                    t.source || n.error("missing source"),
                    t.name && !o(t.name) && n.error("invalid dataset name: " + t.name),
                    this.query = null,
                    this.highlight = !!t.highlight,
                    this.name = t.name || i.getUniqueId(),
                    this.source = t.source,
                    this.displayFn = e(t.display || t.displayKey),
                    this.templates = r(t.templates, this.displayFn),
                    this.$el = n(p.dataset.replace("%CLASS%", this.name));
                }
                function e(t) {
                    function e(e) {
                        return e[t]
                ...
                return t.extractDatasetName = function(t) {
                    ...
                    _render: function(t, e) {
                        ...
                        if (this.$el) {
                            ...
                            this.$el.empty(),
                            h = e && e.length,
                            !h && this.templates.empty ? this.$el.html(r()).prepend(f.templates.header ? l() : null).append(f.templates.footer ? c() : null) : h && this.$el.html(o()).prepend(f.templates.header ? l() : null).append(f.templates.footer ? c() : null),
            ...
            v = function() {
                ...
                function t(t) {
                    var r,
                        ...
                        a = this;
                    t = t || {},
                    t.menu || n.error("menu is required"),
                    this.isOpen = !1,
                    this.isEmpty = !0,
                    this.datasets = i.map(t.datasets, e),
                    r = i.bind(this._onSuggestionClick, this),
                    o = i.bind(this._onSuggestionMouseEnter, this),
                    s = i.bind(this._onSuggestionMouseLeave, this),
                    this.$menu = n(t.menu).on("click.tt", ".tt-suggestion", r).on("mouseenter.tt", ".tt-suggestion", o).on("mouseleave.tt", ".tt-suggestion", s),
                ...
                return i.mixin(t.prototype, f, {
                    ...
                    _onRendered: function() {
                        ...
                        this.isEmpty = i.every(this.datasets, t),
                    ...
                    _moveCursor: function(t) {
                        var e,
                            ...
                            r;
                        if (this.isOpen) {
                            if (n = this._getCursor(), e = this._getSuggestions(), this._removeCursor(), i = e.index(n) + t, i = (i + 1) % (e.length + 1) - 1, i === -1)
                    ...
                    _ensureVisible: function(t) {
                        ...
                        e < 0 ? this.$menu.scrollTop(i + e) : r < n && this.$menu.scrollTop(i + (n - r))
                    },
                    close: function() {
            ...
            y = function() {
                ...
                function t(t) {
                    var o,
                        ...
                        a;
                    t = t || {},
                    t.input || n.error("missing input"),
                    this.isActivated = !1,
                    this.autoselect = !!t.autoselect,
                    this.minLength = i.isNumber(t.minLength) ? t.minLength : 1,
                    this.$node = r(t.input, t.withHint),
                    ...
                    s.on("blur.tt", function(t) {
                        ...
                        r = o.is(n),
                        a = o.has(n).length > 0,
                        i.isMsie() && (r || a) && (t.preventDefault(), t.stopImmediatePropagation(), i.defer(function() {
                            s.focus()
                        }))
                    }),
                ...
                function r(t, e) {
                    var i,
                        ...
                        u;
                    i = n(t),
                    r = n(p.wrapper).css(d.wrapper),
                    s = n(p.dropdown).css(d.dropdown),
                    u = i.clone().css(d.hint).css(o(i)),
                    u.val("").removeData().addClass("tt-hint").removeAttr("id name placeholder required").prop("readonly", !0).attr({
                        autocomplete: "off",
                        spellcheck: "false",
                        tabindex: -1
                    }),
                ...
                function s(t) {
                    ...
                    e.detach().removeData(a).removeClass("tt-input").insertAfter(t),
                    t.remove()
                }
                var a = "ttAttrs";
                return i.mixin(t.prototype, {
                    ...
                    _onDatasetRendered: function() {
                        this.eventBus.trigger("datasetRendered", this.dropdown.$menu),
                        this._updateHint()
                    },
                    _onOpened: function() {
                        this._updateHint(),
                    ...
                    _onEnterKeyed: function(t, e) {
                        ...
                        n ? (this._select(n), e.preventDefault()) : this.autoselect && i && (this._select(i), e.preventDefault())
                    },
                    ...
                    _updateHint: function() {
                        ...
                        t && this.dropdown.isVisible() && !this.input.hasOverflow() ? (e = this.input.getInputValue(), n = m.normalizeQuery(e), r = i.escapeRegExChars(n), o = new RegExp("^(?:" + r + ")(.+$)", "i"), s = o.exec(t.value), s ? this.input.setHint(e + s[1]) : this.input.clearHint()) : this.input.clearHint()
                    },
                    _autocomplete: function(t) {
                        ...
                        e && n !== e && i && (r = this.dropdown.getDatumForTopSuggestion(), r && this.input.setInputValue(r.value), this.eventBus.trigger("autocompleted", r.raw, r.datasetName))
                    },
                    _select: function(t) {
    ...
    _RealScout.Bloodhound = Bloodhound.noConflict();
    var o = t._RealScout,
        s = o.jQuery,
        a = function() {
            _RealScout.FeatureSearch.initAll(),
            _RealScout.RepListings.init(),
            _RealScout.SimpleSearch.init(),
            _RealScout.AdvancedSearch.init()
        };
    ...
    _RealScout.AdvancedSearch = {
        ...
        _initVariables: function() {
            this._wrapper = s(".realscout-search.advanced"),
            this._searchBox = ".search--typeahead input",
            this._dataUrl = _RealScout.getConfig().getAgentHost(this._wrapper.attr("data-rep")) + "/api/v4/omnisearch?query=%QUERY",
            this._statisticsUrl = _RealScout.getConfig().statisticsPath,
            this._buttonColorAttr = "data-button-color",
            this._errorText = "Oops! No Representative Found, please go back to RealScout and copy your widget code again.",
            this._errorClass = "search--widget__blank",
            this._buttonFontColorAttr = "data-button-font",
            this._backgroundColorAttr = "data-background-color",
            this._mainTitleColorAttr = "data-title-color",
            this._buttonClass = ".search--button button",
            this._searchBodyClass = ".search--body",
            this._minBedsInputClass = ".search--input__bmin",
            this._minBathsInputClass = ".search--input__bamin",
            this._minPriceInputClass = ".search--input__pmin",
            this._maxPriceInputClass = ".search--input__pmax"
        },
        _onElementReady: function(e, n, i) {
            var r = 0,
                o = t.setInterval(function() {
                    e(o),
                    ++r === i && t.clearInterval(o)
                }, n)
        },
        ...
        _renderTemplate: function(t) {
            ...
            t.empty(),
            n ? (t.append(e), this._customize(t), this._initTypeahead(t), this._sendStatistics()) : (t.text(this._errorText), t.addClass(this._errorClass))
        },
        _doSearch: function(e, n) {
            if ("undefined" != typeof n) {
                this._openSearch && this._openSearch.close();
                var i = e.attr("data-rep");
                if ("address" === n.type.toLowerCase())
                    this._openSearch = t.open(_RealScout.getConfig().getAgentHost(i) + "/homesearch/listings/" + n.slug);
                else {
                    ...
                    var u = "zoom=12&",
                        l = "geo_type=" + n.type + "&",
                        c = "geo_id=" + n.id;
                    this._openSearch = t.open(_RealScout.getConfig().getAgentHost(i) + "/homesearch/map?" + r + o + s + a + u + l + c)
                }
            }
        },
        ...
        _locationsParams: function(t) {
            ...
            return e.url = this._dataUrl + "&include=geo_items", e.ajax = {}, e.ajax.data = {
                ...
                return 0 === t.places.length && 0 === t.homes.length && 0 === t.schools.length && 0 === t.townships.length ? [{
                    value: "No matching locations",
                    sub_name: "Please check spelling or try a different location",
                    id: "0"
                }] : t.places.concat(t.townships)
            }, e
        },
        ...
        _initTypeaheadEventHandlers: function(t, e) {
            ...
            e.on("keydown", function(t) {
                if (13 === t.which) {
                    ...
                    i.keyCode = i.which = 40,
                    e.trigger(i),
                    i.keyCode = i.which = 9,
                    e.trigger(i),
                    "undefined" != typeof n && e.typeahead("close")
                }
            }.bind(this)),
            t.find(this._buttonClass).on("click", function(e) {
                e.preventDefault(),
                this._doSearch(t, n)
            }.bind(this))
        },
        _customize: function(t) {
            ...
            s(t).find(this._searchBodyClass).css("background-color", i),
            s(t).find("h2").css("color", r),
            s(t).find(this._buttonClass).css("background-color", e).css("color", n)
        }
    },
        ...
        var t = function(t) {
            ...
            e = function() {
                s(".realscout-search.feature").each(function(e, n) {
                    s(n).find("#realscout--kingdom").remove(),
                    t(n)
                })
            };
        return {
    ...
    _RealScout.RepListings = {
        ...
        _initVariables: function() {
            ...
            this._statisticsUrl = _RealScout.getConfig().statisticsPath,
            this._template = u["listings-embedded"],
            this._htmlPath = "module/widgets/embedded/listings-embedded/listings-embedded.html",
            this._errorText = "Oops! No Representative Found, please go back to RealScout and copy your widget code again.",
            this._errorClass = "search--widget__blank",
            this._wrapperClass = ".realscout-listings",
            this._wrappers = s(this._wrapperClass)
        },
        ...
        _newListings: function() {
            this._onElementReady(function(e) {
                this._wrappers.length > 0 && (t.clearInterval(e), s.each(this._wrappers, function(t, e) {
                    e = s(e),
                    e.hasClass("agent") ? this._initAgentListings(e) : e.hasClass("office") ? this._initOfficeListings(e) : e.hasClass("single") && this._initSingleListings(e)
                }.bind(this)).bind(this))
            }.bind(this), 500, 20)
        },
        _sendStatistics: function() {
            ...
            if (e.properties.length > 6) {
                ...
                i.pagination({
                    ...
                    onInit: function() {
                        if (i)
                            for (var t = e.properties.length / 6, n = t; n >= 1; n--)
                                if (s('a[href="#page-' + n + '"]').click(o), 0 === n)
                                    s(".page-1").addClass("active");
                                else {
                                    var r = s(".page-" + (n + 1));
                    ...
                    onPageClick: function(e) {
                        s("a.page-link").bind("click", o),
                        r || (r = 1),
                        n.find(".page-" + r).removeClass("active"),
                        n.find(".page-" + e).addClass("active"),
                        r = e,
                        s(t).scroll()
                    }
                })
        ...
        _initAgentListings: function(t) {
            var e = t.attr("data-rep"),
                ...
                i = function(n) {
                    n.restricted_layout = this._initLayoutSetup(t),
                    n.display_view = this._initViewStyle(t),
                    n.grid = "grid__view" === n.display_view,
                    this._renderTemplate(t, n, e)
                },
                r = {
        ...
        _customize: function(t, e) {
            ...
            return t.rep = e, s.each(t.properties, function(e, i) {
                i.property_basics.property_href = _RealScout.getConfig().getAgentHost(t.rep) + "/property/" + i.id,
                i.property_basics.display_price = "$" + parseInt(i.property_basics.display_price).toFixed(1).replace(/(\d)(?=(\d{3})+\.)/g, "$1,").slice(0, -2),
                (e + 1) % 6 === 0 && (n++, i.paginate = n)
            }), t
        },
        _initLazyLoading: function() {
            ...
            for (var c = e.querySelectorAll("img[data-echo]"), p = 0; p <= c.length; p++)
                new n(c[p]).init()
        }
    },
    _RealScout.SimpleSearch = {
        ...
        _initVariables: function() {
            this._wrapper = s(".realscout-search.simple"),
            this._searchBox = ".search--input input",
            this._dataUrl = _RealScout.getConfig().getAgentHost(this._wrapper.attr("data-rep")) + "/api/v4/omnisearch?query=%QUERY",
            this._statisticsUrl = _RealScout.getConfig().statisticsPath,
            this._htmlTemplate = u["simple-search"],
            this._htmlPath = "module/widgets/embedded/simple-search/simple-search.html",
            this._buttonColorAttr = "data-button-color",
            this._buttonFontColorAttr = "data-button-font",
            this._backgroundColorAttr = "data-background-color",
            this._mainTitleColorAttr = "data-title-color",
    ...
    u["feature-search"] = new r.Template({
        code: function(t, e, n) {
            ...
            return i.b(n = n || ""), i.b('<section class="realscout--listings feature--listings">'), i.b("\n"), i.b("\n" + n), i.s(i.f("categories", t, e, 1), t, e, 0, 74, 480, "{{ }}") && (i.rs(t, e, function(t, e, i) {
                i.b('  <div class="realscout--listing feature--listing">'),
                i.b("\n" + n),
                i.b('    <div class="listing--image__container">'),
                i.b("\n" + n),
                i.b('      <a href="'),
                i.b(i.v(i.f("agentHost", t, e, 0))),
                i.b("/categories/"),
                i.b(i.v(i.f("id", t, e, 0))),
                i.b('" target="_blank">'),
                i.b("\n" + n),
                i.b('        <img class="listing--image" src="'),
                i.b(i.v(i.f("hd_image_url", t, e, 0))),
                i.b('" alt="'),
                i.b(i.v(i.f("id", t, e, 0))),
                i.b('">'),
                i.b("\n" + n),
                ...
                i.b("    </div>"),
                i.b("\n" + n),
                i.b('    <header class="listing--header">'),
                i.b("\n" + n),
                i.b('      <h2 class="listing--title">'),
                i.b("\n" + n),
                i.b("        "),
                i.b(i.v(i.f("name", t, e, 0))),
                i.b("\n" + n),
                i.b("      </h2>"),
                i.b("\n" + n),
                i.b("    </header>"),
                i.b("\n" + n),
                i.b("  </div><!-- end of #listing -->"),
                i.b("\n" + n)
    ...
    u["listings-embedded"] = new r.Template({
        code: function(t, e, n) {
            ...
            return i.b(n = n || ""), i.b('<div id="realscout--kingdom">'), i.b("\n" + n), i.b('  <div id="realscout--kingdom__castle">'), i.b("\n" + n), i.b('    <div id="kingdom--castle">'), i.b("\n" + n), i.b('      <div id="kingdom--castle__throne">'), i.b("\n" + n), i.b('        <section class="realscout--listings home--listings '), i.b(i.v(i.f("restricted_layout", t, e, 0))), i.b(" "), i.b(i.v(i.f("display_view", t, e, 0))), i.b('">'), i.b("\n" + n), i.b('          <div class="home--listings__page pages page-1 active">'), i.b("\n" + n), i.s(i.f("properties", t, e, 1), t, e, 0, 334, 3456, "{{ }}") && (i.rs(t, e, function(t, e, i) {
                i.b('              <a class="realscout--listing home--listing" role="button" href="'),
                i.b(i.v(i.d("property_basics.property_href", t, e, 0))),
                i.b('" target="_blank">'),
                i.b("\n" + n),
                i.b('                <div class="listing--image__container">'),
                i.b("\n" + n),
                i.b('                  <img class="listing--image" src="" data-echo="'),
                i.b(i.v(i.d("property_basics.image_url", t, e, 0))),
                i.b('" alt="'),
                i.b(i.v(i.f("id", t, e, 0))),
                i.b('">'),
                i.b("\n" + n),
                i.b("                </div>"),
                i.b("\n" + n),
                i.b('                <header class="listing--header home--header">'),
                i.b("\n" + n),
                i.s(i.f("grid", t, e, 1), t, e, 0, 742, 1926, "{{ }}") && (i.rs(t, e, function(t, e, i) {
                    i.b('                  <p class="listing--description">'),
                    i.b("\n" + n),
                    i.b('                    <span class="listing--description__item">'),
                    i.b(i.v(i.d("property_basics.display_price", t, e, 0))),
                    i.b("</span>"),
                    i.b("\n"),
                    i.b("\n" + n),
                    i.s(i.d("property_basics.beds", t, e, 1), t, e, 0, 942, 1060, "{{ }}") && (i.rs(t, e, function(t, e, i) {
                        i.b('                    <span class="listing--description__item">'),
                        i.b(i.v(i.d("property_basics.beds", t, e, 0))),
                        i.b(" Bed</span>"),
                        i.b("\n" + n)
                    }), t.pop()),
                    i.b("\n" + n),
                    i.s(i.d("property_basics.baths", t, e, 1), t, e, 0, 1133, 1253, "{{ }}") && (i.rs(t, e, function(t, e, i) {
                        i.b('                    <span class="listing--description__item">'),
                        i.b(i.v(i.d("property_basics.baths", t, e, 0))),
                        i.b(" Bath</span>"),
                        i.b("\n" + n)
                    }), t.pop()),
                    i.b("\n" + n),
                    i.s(i.d("property_basics.lal", t, e, 1), t, e, 0, 1325, 1442, "{{ }}") && (i.rs(t, e, function(t, e, i) {
                        i.b('                    <span class="listing--description__item">'),
                        i.b(i.v(i.d("property_basics.lal", t, e, 0))),
                        i.b(" Lot</span>"),
                        i.b("\n" + n)
                    }), t.pop()),
                    i.b("\n" + n),
                    i.b('                    <span class="listing--description__item">'),
                    i.b(i.v(i.d("property_basics.listing_status", t, e, 0))),
                    i.b("</span>"),
                    i.b("\n" + n),
                    i.b("                  </p>"),
                    i.b("\n" + n),
                    i.b('                  <p class="listing--description">'),
                    i.b("\n" + n),
                    i.b('                    <span class="listing--description__item address">'),
                    i.b(i.v(i.d("property_basics.street_address", t, e, 0))),
                    i.s(i.d("property_basics.street_address", t, e, 1), t, e, 0, 1783, 1784, "{{ }}") && (i.rs(t, e, function(t, e, n) {
                        n.b(",")
                    }), t.pop()),
                    i.b(" "),
                    i.b(i.v(i.d("property_basics.city", t, e, 0))),
                    i.b(", "),
                    i.b(i.v(i.d("property_basics.postal_code", t, e, 0))),
                    i.b("</span>"),
                    i.b("\n" + n),
                    i.b("                  </p>"),
                    i.b("\n" + n)
                }), t.pop()),
                i.s(i.f("grid", t, e, 1), t, e, 1, 0, 0, "") || (i.b('                  <p class="listing--description">'), i.b("\n" + n), i.b('                    <span class="listing--description__item">'), i.b(i.v(i.d("property_basics.listing_status", t, e, 0))), i.b("</span>"), i.b("\n" + n), i.b("                  </p>"), i.b("\n" + n), i.b('                  <p class="listing--description">'), i.b("\n" + n), i.b('                    <span class="listing--description__item address">'), i.b(i.v(i.d("property_basics.street_address", t, e, 0))), i.s(i.d("property_basics.street_address", t, e, 1), t, e, 0, 2330, 2331, "{{ }}") && (i.rs(t, e, function(t, e, n) {
                    n.b(",")
                ...
                i.b("                </header>"),
                i.b("\n" + n),
                i.b("              </a><!-- end of #listing -->"),
                i.b("\n" + n),
                i.s(i.f("paginate", t, e, 1), t, e, 0, 3334, 3430, "{{ }}") && (i.rs(t, e, function(t, e, i) {
                    i.b('                </div><div class="home--listings__page pages page-'),
                    i.b(i.v(i.f("paginate", t, e, 0))),
                    i.b('">'),
                    i.b("\n" + n)
                }), t.pop())
